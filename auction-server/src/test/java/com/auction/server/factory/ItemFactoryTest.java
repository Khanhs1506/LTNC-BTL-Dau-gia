...
public class ItemFactoryTest {
    ...
    // -----------------------------------------------------------------------
    // NHÓM 1: Tạo sản phẩm điện tử (ElectronicsItem)
    // -----------------------------------------------------------------------

    @Test
    void taoElectronics_phaiTaoRaDungLoai() {
        // createItem("ELECTRONICS", id, tên, giá, "số tháng bảo hành")
    ...
    // -----------------------------------------------------------------------
    // NHÓM 2: Tạo sản phẩm nghệ thuật (ArtItem)
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // NHÓM 3: Tạo phương tiện (VehicleItem)
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // NHÓM 4: Các trường hợp type không hợp lệ
    // -----------------------------------------------------------------------
    ...
    void typeVietThuong_vanTaoRaDuocItem() {
        // "electronics" viết thường vẫn phải hoạt động (factory dùng toUpperCase)
